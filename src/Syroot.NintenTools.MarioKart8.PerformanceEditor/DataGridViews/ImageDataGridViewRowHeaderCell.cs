...
namespace Syroot.NintenTools.MarioKart8.PerformanceEditor
{
    ...
    internal class ImageDataGridViewRowHeaderCell : DataGridViewRowHeaderCell
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageDataGridViewRowHeaderCell"/> displaying the given
        ...
        internal ImageDataGridViewRowHeaderCell(string text, Image image)
        {
            _text = text;
            _image = image;
        }
